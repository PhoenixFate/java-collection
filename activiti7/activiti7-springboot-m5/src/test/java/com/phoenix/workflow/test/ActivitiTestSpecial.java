...
@SpringBootTest
public class ActivitiTestSpecial {

    private static final Logger LOGGER = LoggerFactory.getLogger(ActivitiTestSpecial.class);
    ...
    public void deploy() throws IOException {
        //1.查询流程定义json字节码
        String modelId = "513e3ad2-0911-11ed-a10c-fedb4667e4da";
    ...
    public void startProcess()  {
        //1.启动流程实例
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("leaveProcessM5","46666");
