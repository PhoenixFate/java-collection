...
@SpringBootTest
public class ActivitiTestInclusiveGateway12 {
    ...
    public void deploy() throws IOException {
        //1.查询流程定义json字节码
        String modelId = "bbc5be3c-0839-11ed-9224-9a14701eeabd";
    ...
    public void startProcess() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("leaveInclusiveGateway","2244", variables);
    ...
    public void findWaitTask(){
        List<Task> taskList = taskService.createTaskQuery().taskAssignee("meng")
                .processDefinitionKey("leaveInclusiveGateway").list();
