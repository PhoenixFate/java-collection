          ...
          <div class="content">
            <div class="item" v-for="order in orderList">
              ...
              <div class="item-content">
                <div class="item-left col-lg-2"><img v-if="courseMap[order.xcOrdersDetails[0].itemId] && courseMap[order.xcOrdersDetails[0].itemId].pic" :src="'http://img.xuecheng.test/'+JSON.parse(courseMap[order.xcOrdersDetails[0].itemId].pic)[0]" width="100%" alt="" ></div>
