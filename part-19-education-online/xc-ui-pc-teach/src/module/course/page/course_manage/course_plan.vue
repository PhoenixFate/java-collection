<template>
  <div>
    <el-button type="primary" @click="teachPlanFormVisible = true">添加课程计划</el-button>
    <el-tree
      :data="teachPlanList"
      :props="defaultProps"
      node-key="id"
    ...
    <el-dialog title="添加课程计划" :visible.sync="teachPlanFormVisible">
...
export default {
  ...
  data() {
    return {
      ...
      teachPlanFormVisible: false,//控制添加窗口是否显示
      teachPlanList: [{
        id: 1,
        pname: '一级 1',
        children: [{
